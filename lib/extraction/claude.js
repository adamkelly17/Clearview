...

{
  ...
  "lines": [ { "description": string, "quantity": number, "unit_price": number, "net_amount": number, "vat_rate": number, "vat_amount": number } ],
...
export async function extractWithClaude({ fileBuffer, mimeType, fileName }) {
