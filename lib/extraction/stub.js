...
const FIXTURES = {
  clean: {
    ...
    lines: [
      { description: 'Oak board 20mm, 2.4m', quantity: 14, unit_price: 62.5, net_amount: 875, vat_rate: 20, vat_amount: 175, account_code: '5001' },
      { description: 'Softwood batten 38x63', quantity: 30, unit_price: 8.15, net_amount: 244.5, vat_rate: 20, vat_amount: 48.9, account_code: '5001' },
      { description: 'Delivery', quantity: 1, unit_price: 165, net_amount: 165, vat_rate: 20, vat_amount: 33, account_code: '5100' },
    ],
    confidence: {
  ...
  mixed: {
    ...
    lines: [
      { description: 'Site boards, printed', quantity: 4, unit_price: 147.5, net_amount: 590, vat_rate: 20, vat_amount: 118, account_code: '6201' },
      { description: 'Printed brochures (zero rated)', quantity: 500, unit_price: 0.7, net_amount: 350, vat_rate: 0, vat_amount: 0, account_code: '7500' },
    ],
    confidence: {
  ...
  reverse: {
    ...
    lines: [
      { description: 'First fix carpentry, plots 3–7', quantity: 1, unit_price: 2600, net_amount: 2600, vat_rate: 20, vat_amount: 0, account_code: '5002' },
      { description: 'Second fix, plot 3', quantity: 1, unit_price: 650, net_amount: 650, vat_rate: 20, vat_amount: 0, account_code: '5002' },
    ],
    confidence: {
  ...
  broken: {
    ...
    lines: [
      { description: 'Excavator hire, 3 weeks', quantity: 3, unit_price: 340, net_amount: 1020, vat_rate: 20, vat_amount: 204, account_code: '7700' },
      { description: 'Breaker attachment', quantity: 1, unit_price: 160, net_amount: 160, vat_rate: 20, vat_amount: 32, account_code: '7700' },
    ],
    confidence: {
  ...
  unknown: {
    ...
    lines: [
      { description: 'Scaffold erection and 4 week hire', quantity: 1, unit_price: 1850, net_amount: 1850, vat_rate: 20, vat_amount: 370, account_code: '5002' },
      { description: 'Dismantle', quantity: 1, unit_price: 300, net_amount: 300, vat_rate: 20, vat_amount: 60, account_code: '5002' },
    ],
    confidence: {
